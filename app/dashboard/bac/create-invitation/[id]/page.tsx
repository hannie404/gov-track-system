...
import { BidInvitationForm } from '@/components/bac/bid-invitation-form';
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl">
          <div className="mb-8">
            <h2 className="text-4xl font-bold text-foreground">Create Bid Invitation</h2>
            <p className="text-muted-foreground mt-2">{project.title}</p>
          </div>

          <BidInvitationForm project={project} userId={user.id} />
        </div>
      </main>
    </div>
  );
