    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-4xl font-bold text-foreground">Planner Dashboard</h2>
            <p className="text-muted-foreground mt-2">Create and manage project proposals for review</p>
          </div>
